...
**Note:** Use your own Anthropic API key for direct billing to Anthropic, or use Chucky's pooled access.
...
```
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│   Your Server   │     │   Chucky Edge   │     │    Request      │
│                 │     │                 │     │                 │
│  Creates token  │────▶│  Validates JWT  │────▶│  Allowed if     │
│  with budget:   │     │  Checks budget  │     │  within budget  │
│  $5/day         │     │  for user       │     │                 │
│                 │     │                 │     │  Rejected if    │
│                 │     │  Tracks usage   │◀────│  over budget    │
└─────────────────┘     └─────────────────┘     └─────────────────┘
```

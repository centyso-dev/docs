...
Get your **Project ID** and **HMAC Secret** from your project settings at [app.chucky.cloud](https://app.chucky.cloud).
...
token = create_token(
    user_id='user-123',
    project_id=os.environ['CHUCKY_PROJECT_ID'],  # From portal project settings
    secret=os.environ['CHUCKY_HMAC_SECRET'],     # From portal project settings
...
<Info>
  The **Project ID** and **HMAC Secret** are separate values found in your project settings at [app.chucky.cloud](https://app.chucky.cloud).

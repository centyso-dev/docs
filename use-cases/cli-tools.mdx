...
```
┌──────────────────┐        ┌──────────────────┐        ┌──────────────────┐
│   Your CLI       │        │   Chucky Cloud   │        │  User's Machine  │
│                  │        │                  │        │                  │
│  chucky prompt   │───────▶│  Claude thinks   │        │                  │
│  "fix TS errors" │        │  decides actions │        │                  │
│                  │        │        │         │        │                  │
│                  │        │        ▼         │        │                  │
│                  │◀───────│  tool_call:      │        │                  │
│                  │        │  HostBash        │        │                  │
│                  │        │                  │        │                  │
│  Execute locally │────────────────────────────────────▶│  tsc --noEmit   │
│                  │◀────────────────────────────────────│  (errors)       │
│                  │        │                  │        │                  │
│  Send result     │───────▶│  Claude sees     │        │                  │
│                  │        │  errors, plans   │        │                  │
│                  │        │  fixes           │        │                  │
│                  │        │        │         │        │                  │
│                  │◀───────│  tool_call:      │        │                  │

...
| Generate Tests | `chucky prompt "Generate unit tests for changed files"` |
| Update Docs | `chucky prompt "Update README based on recent changes"` |
| Fix Linting | `chucky prompt "Fix all ESLint errors"` |
| Translate | `chucky prompt "Translate strings to Spanish"` |
| Deprecation | `chucky prompt "Update deprecated API usage"` |
